...
export class Pose {
   ...
   * @param {Pose} pose The Pose to add to this one.
   ...
   * @param {Pose} pose The Pose to subtract from this one.
  ...
  /**
   * Serialize this Pose for JSON storage or transmission.
  ...
  /**
   * Deserialize JSON data into a Pose instance.
   * @param {SerializedPose} data Serialized data to be deserialized into a Pose instance.
   * @returns {Pose} A new Pose
   */
   ...
   * @param {SerializedPose} data Data to be validated.
